...
const Nav = ({Navleft,Navright}) => {
  ...
  return (
    <>
      ...
      <div   className={`w-[22vh]  ${popup ? 'block' : 'hidden'} z-50 lg:hidden absolute right-3 h-[14vh] font-medium items-start pl-5 gap-2 pt-3 flex flex-col shadow-lg shadow-[#c3c2c2] bg-white `}>
